...
namespace backend.Controllers
{
    ...
    public class NotificationController : ControllerBase
    {
        ...
        [HttpGet]
        public async System.Threading.Tasks.Task<IActionResult> GetNotifications([FromQuery] string filter = "all", [FromQuery] int page = 1, [FromQuery] int pageSize = 10)
        {
        ...
        [HttpPost("{id}/unread")]
        public async System.Threading.Tasks.Task<IActionResult> MarkAsUnread(string id)
        {
        ...
        [HttpGet("stream")]
        public async System.Threading.Tasks.Task Stream(CancellationToken cancellationToken)
        {
